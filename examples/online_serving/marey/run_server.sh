...
[[ -n "${MAREY_LOAD_COND_FRAMES_PATH:-}" ]]    && env_args+=("MAREY_LOAD_COND_FRAMES_PATH=${MAREY_LOAD_COND_FRAMES_PATH}")
[[ -n "${MAREY_LOAD_COND_OFFSETS_PATH:-}" ]]   && env_args+=("MAREY_LOAD_COND_OFFSETS_PATH=${MAREY_LOAD_COND_OFFSETS_PATH}")
[[ -n "${MAREY_LOAD_PIPELINE_LATENTS_DIR:-}" ]] && env_args+=("MAREY_LOAD_PIPELINE_LATENTS_DIR=${MAREY_LOAD_PIPELINE_LATENTS_DIR}")
